      ...
      <div class="col-lg d-flex align-items-stretch">
        <div class="card w-100">
          <div class="card-body p-4">
            <h5 class="card-title fw-semibold mb-4">تعديل معلومات حسابات التواصل الاجتماعي </h5>
            <div class="card">
                <div class="card-body" style="padding: 20px">
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">انستجرام</label>
                        <div>
                            <input class="form-control" type="email" name="" id="" value="https://www.instagram.com/rawaa_mhmd/">
                        </div>
                    </div>
                    <div class="mb-3">
